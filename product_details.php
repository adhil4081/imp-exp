                        ...
                        <div class="service-sidebar default-sidebar">
                            <div class="sidebar-widget category-widget">
                                <ul class="category-list clearfix">
                                    <li><a href="product_details.php?id=1" <?php if ($idv=="1") { echo ' class="current" '; } ?> >FRUITS & VEGETABLES</a></li>
                                    <li><a href="product_details.php?id=2" <?php if ($idv=="2") { echo ' class="current" '; } ?> >FOOD STUFF</a></li>
                                    <li><a href="product_details.php?id=3" <?php if ($idv=="3") { echo ' class="current" '; } ?> >NON FOOD STUFF</a></li>
                                    <li><a href="product_details.php?id=4" <?php if ($idv=="4") { echo ' class="current" '; } ?> >ROASTERY</a></li>
                                    <li><a href="product_details.php?id=5" <?php if ($idv=="5") { echo ' class="current" '; } ?> >SPICES</a></li> 
                                    <li><a href="product_details.php?id=6" <?php if ($idv=="5") { echo ' class="current" '; } ?> >TEXTILE</a></li> 
                                    <li><a href="product_details.php?id=7" <?php if ($idv=="5") { echo ' class="current" '; } ?> >FOOTWEAR</a></li> 
                                    <li><a href="product_details.php?id=8" <?php if ($idv=="5") { echo ' class="current" '; } ?> >HOUSEHOLD</a></li> 
                                    <li><a href="product_details.php?id=9" <?php if ($idv=="5") { echo ' class="current" '; } ?> >MACHINERY</a></li> 
                                    <li><a href="product_details.php?id=10" <?php if ($idv=="5") { echo ' class="current" '; } ?> >BRANDING</a></li> 
